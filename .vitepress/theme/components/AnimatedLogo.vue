...
function pointOnStrand(strand: [number, number][], t: number): [number, number] {
  const segCount = strand.length - 1;
  const clampedT = Math.min(Math.max(t, 0), 1);
  const segIndex = Math.min(Math.max(Math.floor(clampedT * segCount), 0), segCount - 1);
...
<template>
  <div class="animated-logo">
    <svg viewBox="0 0 725 545">
      ...
      <g class="wordmark" :class="{ visible: wordVisible }" :style="{ fill: textColor }">
        <!-- "München." — paths copied unchanged from RIT_Basislogo_weiss.svg -->
        <g class="word-group" style="transition-delay: 0.05s">
          <path d="m290.18,338.09l28.73,66.68,29.36-66.68h10.49v76.53h-6.89v-70.7h-.21l-29.26,70.7h-6.89l-29.26-70.39h-.21v70.39h-6.89v-76.53h11.02Z"/>
          <path d="m375.3,361.41h6.36v34.66c0,8.48,4.98,14.31,13.99,14.31,10.18,0,15.26-8.48,15.26-17.92v-31.06h6.36v41.98c0,.85,0,2.01.11,3.29l.42,7.95h-6.57l-.32-7.84-.21-.21c-3.71,6.57-9.75,9.65-16.64,9.65-12.51,0-18.76-8.37-18.76-21.2v-33.6Zm16.22-23v9.33h-7.84v-9.33h7.84Zm18.45,0v9.33h-7.84v-9.33h7.84Z"/>
          <path d="m474.09,381.02v33.6h-6.36v-34.77c0-8.38-5.09-14.21-13.99-14.21-9.65,0-15.26,7.84-15.26,18.13v30.85h-6.36v-41.98c0-2.33,0-4.35-.53-11.24h6.57l.32,7.84.21.21c3.71-6.57,9.75-9.65,16.64-9.65,12.61,0,18.76,8.38,18.76,21.2Z"/>
          <path d="m529.42,377.74h-6.89c-.53-8.16-5.72-12.08-14.52-12.08-9.33,0-15.79,9.54-15.79,22.26s6.47,22.47,15.79,22.47c7.84,0,13.89-4.66,14.52-12.4h6.89c-1.7,12.19-8.59,18.23-20.78,18.23-14.52,0-23.32-11.87-23.32-28.2s9.12-28.2,23.75-28.2c11.02,0,19.72,6.57,20.35,17.91Z"/>
          <path d="m539.81,338.09h6.36v31.38h.21c3.71-6.57,9.86-9.65,16.64-9.65,12.4,0,18.76,8.16,18.76,21.2v33.6h-6.36v-34.45c0-9.12-5.19-14.52-13.99-14.52-9.75,0-15.26,7.95-15.26,18.23v30.74h-6.36v-76.53Z"/>
          <path d="m641.46,389.5h-41.13c.32,13.46,7.1,20.88,18.44,20.88,7.31,0,13.67-5.3,15.37-12.72h6.68c-3.29,12.72-11.24,18.55-23.96,18.55-14.95,0-23.43-12.19-23.43-28.2s9.22-28.2,23.75-28.2c15.58,0,24.17,10.07,24.27,29.68Zm-6.89-5.83c-.85-11.34-7.21-18.02-17.38-18.02-8.9,0-15.37,6.68-16.64,18.02h34.03Z"/>
          <path d="m695.41,381.02v33.6h-6.36v-34.77c0-8.38-5.09-14.21-13.99-14.21-9.65,0-15.26,7.84-15.26,18.13v30.85h-6.36v-41.98c0-2.33,0-4.35-.53-11.24h6.57l.32,7.84.21.21c3.71-6.57,9.75-9.65,16.64-9.65,12.61,0,18.76,8.38,18.76,21.2Z"/>
